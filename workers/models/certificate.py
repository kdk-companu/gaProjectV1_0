...
class Сertificates(ChangeloggableMixin, models.Model):
    ...
    class Meta:
        ...
        verbose_name_plural = 'Сертификаты'  # Во множественнмо числе
...
class Сertificate_Parts(ChangeloggableMixin, models.Model):
    ...
    class Meta:
        ...
        verbose_name_plural = 'Сертификаты части'  # Во множественнмо числе
        ordering = ['pk']  # Сортировка по каким полям, - обратная сортировка
        default_permissions = ('')
...
class Сertificate_Users(ChangeloggableMixin, models.Model):
    ...
    chief = models.ForeignKey(Chief, on_delete=models.PROTECT, blank=True,
                              null=False, verbose_name='Должность')
    file1 = models.FileField(upload_to=user_directory_certificate1,
                             verbose_name='Скан №1',
                             null=True, blank=True)
    file2 = models.FileField(upload_to=user_directory_certificate2,
                             verbose_name='Скан №2',
                             null=True, blank=True)
    file3 = models.FileField(upload_to=user_directory_certificate3,
                             verbose_name='Скан №3',
                             null=True, blank=True)
    ...
    # Переписанная функция сохранения
    ...
    class Meta:
        ...
        verbose_name_plural = 'Сертификаты работников'  # Во множественнмо числе
        ordering = ['pk']  # Сортировка по каким полям, - обратная сортировка
